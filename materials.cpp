...
bool Diffuse::Scatter(Ray *ray_in, HitRecord *record, Colour *attenuation,
                      Ray *ray_out) {
  *attenuation = colour;
...
bool Mirror::Scatter(Ray *ray_in, HitRecord *record, Colour *attenuation,
                     Ray *ray_out) {
  Vector3 direction =
      ray_in->direction -
...
bool PartialDiffuse::Scatter(Ray *ray_in, HitRecord *record,
